...
$lang['email_send_failure_phpmail'] = "Não foi possível enviar e-mail através da função mail() do PHP. O seu servidor pode não estar configurado para enviar e-mails usando este método.";
$lang['email_send_failure_sendmail'] = "Não foi possível enviar e-mail usando PHP Sendmail. O seu servidor pode não estar configurado para enviar e-mails usando este método.";
$lang['email_send_failure_smtp'] = "Não foi possível enviar e-mail usando PHP SMTP. O seu servidor pode não estar configurado para enviar e-mails usando este método.";
