<!--PAGE CONTENT ENDS-->
		...
		<script src="/assets/admin/js/fuelux/fuelux.spinner.min.js"></script>
		<script src="/assets/admin/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="/assets/admin/js/date-time/bootstrap-timepicker.min.js"></script>
		<script src="/assets/admin/js/date-time/moment.min.js"></script>
		<script src="/assets/admin/js/date-time/daterangepicker.min.js"></script>
		...
		<script src="/assets/admin/js/bootstrap-tag.min.js"></script>
