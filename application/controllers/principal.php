...
class Principal extends BaseCrud{
  var $id_palestra;
  
  var $modelname = 'recibo'; //Nome da model sem o "_model"
  var $titulo = 'Recibo';
  var $campos_busca = 'nomeEmissor'; //Campos para filtragem
  var $base_url = 'principal';
  var $actions = 'CRUD';// C: CREATE; R:READ; U:UPDATE; D:DELETE
  var $delete_fields = '';
  var $tabela = 'nomeEmissor'; //Campos que aparecerão na tabela de listagem
